      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '32px 24px' }}>
        ...
        {loading ? <p style={{ color: '#94a3b8' }}>Loading...</p> : tickets.length === 0 ? (
          ...
          <div style={{ background: '#fff', borderRadius: '12px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
            {/* Table header */}
            <div style={{
              display: 'grid', gridTemplateColumns: '60px 2fr 1fr 1fr 1fr 1.2fr 100px',
              ...
              <span>ID</span><span>Title</span><span>Category</span><span>Priority</span><span>Status</span><span>Assigned To</span><span style={{ textAlign: 'right' }}>Action</span>
            </div>
            {tickets.map((t, i) => (
              <div key={t.id}
              ...
              >
                ...
                <span style={{ fontWeight: 600, fontSize: '14px', color: '#0f172a', paddingRight: '12px' }}>{t.title}</span>
                ...
                <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                  {!t.assigned_to ? (
                    ...
                    <span style={{ fontSize: '12px', color: '#94a3b8', marginRight: '12px' }}>—</span>
                  )}
                </div>
              </div>
            ))}
